...
const BoardView = ({ id, setIsModalNewTaskOpen }: Props) => {
  ...
  if (error) return <div>An error accurred while fetching tasks</div>;
  return (
  ...
  return (
    ...
    >
      <div className="mb-3 flex w-full">
        ...
        />
        <div className="roudend-e-lg flex w-full items-center justify-between bg-white px-5 py-4 dark:bg-dark-secondary">
          <h3 className="flex items-center text-lg font-semibold dark:text-white">
            {status}{" "}
            <span
              className="ml-2 inline-block rounded-full bg-gray-200 p-1 text-center text-sm leading-none dark:bg-dark-terciary"
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-3-images.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://pm-3-images.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-3-images.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl}`}
